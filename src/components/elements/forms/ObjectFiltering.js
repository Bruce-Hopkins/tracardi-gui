...
export default function ObjectFiltering({type, where, onFilterClick, initRefresh, onRefreshChange}) {
    ...
    return <section className="ObjectFiltering">
        <div className="Input">
            ...
            />
            <div style={{fontSize: 12}}>Do not know how to filter. Click <span style={{textDecoration: "underline", cursor: "pointer"}} onClick={external("http://manual.tracardi.com/getting_started/codings/search/searchng_after_082/", true)}>here</span> for information.</div>
        </div>
